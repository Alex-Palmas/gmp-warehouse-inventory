...
Related application: DOC-WH-INV-001 v1.1. This URS is a **template**. Do not treat it as pre-approved.
...
| URS-06 | Append-only audit trail: UTC, local, userId, userName, action, recordId, field, old, new, reasonForChange, meaningOfSignature | 11.10(e) audit trail | 211.180, 211.188, 211.194 as applicable to records | 11.9 audit trails | Contemporaneous, Complete |
...
| URS-16 | Roles: Operator, Supervisor, QA, Read-Only as specified | 11.10(g) | 211.25; 211.68 | 11.12 | Attributable |
| URS-17 | Dashboard: counts by status, expired, 30/90 day expiry, quarantine aging | — | 211.142; 211.150 | 11.6 | Available |
| URS-18 | Document-control footer DOC-WH-INV-001 v1.1 and validation banner on screens and exports | 11.10(k) | 211.100; 211.180 | 11.4 | Consistent |
